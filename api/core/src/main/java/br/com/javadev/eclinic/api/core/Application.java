package br.com.javadev.eclinic.api.core;
...
@EnableWebMvc
@ComponentScan(basePackages = { "br.com.javadev.eclinic.api.core.services", "br.com.javadev.eclinic.infrastructure.medic.business", 
...
@EnableCaching
@EnableAsync
@EnableJpaRepositories(basePackages = { "br.com.javadev.eclinic.infrastructure.medic.repositories" })
...
public class Application {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("br.com.javadev.eclinic.infrastructure.medic.entities");
